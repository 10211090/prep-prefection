    ...
    private void showBottomDialog() {
        ...
        videoLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intCartValue > 0){
                    dialog.dismiss();
                    startActivity(new Intent(NotifActivity.this, CartActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));
                }else{
                    dialog.dismiss();
                    Toast.makeText(NotifActivity.this,"Silahkan memasukkan Produk ke Keranjang Belanja terlebih dahulu",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        shortsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                startActivity(new Intent(NotifActivity.this, ResepActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));
    ...
    private void showPromoDialog() {
        ...
        promo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                Toast.makeText(NotifActivity.this,"25% Discount telah di klaim dan sedang digunakan",Toast.LENGTH_SHORT).show();
